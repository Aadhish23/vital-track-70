  ...
  "rounded-xl border text-card-foreground",
  {
    variants: {
      variant: {
        ...
        glassHover: "bg-card/80 backdrop-blur-xl border-border/50 transition-all duration-300 hover:border-primary/30",
        elevated: "bg-card border-border shadow-lg",
        status: "bg-card/80 backdrop-blur-xl border-border/50 border-l-4",
      },
    },
    defaultVariants: {
      variant: "glass",
